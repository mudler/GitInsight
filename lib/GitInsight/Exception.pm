package GitInsight::Exception;
 ...
 sub _detect {
   ...
   return $msg if defined $msg && $msg->isa('GitInsight::Exception');
   $self->message($msg);
 ...
 GitInsight::Exception - Exceptions with context
 
 =head1 SYNOPSIS
 
   use GitInsight::Exception;
 
   # Throw exception
   GitInsight::Exception->throw('Not again!');
 
   # Customize exception
   die GitInsight::Exception->new('Not again!')->trace(2)->verbose(1);
 
 =head1 DESCRIPTION
 
 L<GitInsight::Exception> is a container for exceptions with context information.
 
 =head1 ATTRIBUTES
 
 L<GitInsight::Exception> implements the following attributes.
 ...
 L<GitInsight::Exception> inherits all methods from L<GitInsight::Base> and implements the
 following new ones.
 
 =head2 new
 
   my $e = GitInsight::Exception->new('Oops!');
   my $e = GitInsight::Exception->new('Oops!', $files);
 
 Construct a new L<GitInsight::Exception> object.
 
 =head2 throw
 
   GitInsight::Exception->throw('Oops!');
   GitInsight::Exception->throw('Oops!', $files);
 ...
 L<GitInsight::Exception> overloads the following operators.
