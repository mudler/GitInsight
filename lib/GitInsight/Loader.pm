package GitInsight::Loader;
 use GitInsight::Base -base;
 
 use File::Basename 'fileparse';
 use File::Spec::Functions qw(catdir catfile splitdir);
 use GitInsight::Exception;
 use GitInsight::Util qw(b64_decode class_to_path);
 ...
 sub load {
   ...
   # Real error
   return GitInsight::Exception->new($@);
 }
 ...
 GitInsight::Loader - Loader
 
 =head1 SYNOPSIS
 
   use GitInsight::Loader;
 
   # Find modules in a namespace
   my $loader = GitInsight::Loader->new;
 ...
 L<GitInsight::Loader> is a class loader and plugin framework.
 
 =head1 METHODS
 
 L<GitInsight::Loader> inherits all methods from L<GitInsight::Base> and implements the
 following new ones.
